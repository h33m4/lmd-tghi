...
export const metadata = {
  ...metaObject("Sierra Leone | Data Review Reports"),
};

const SierraLeoneReportsPage = () => {
  return (
    <>
      <TopNavBar country={"Sierra Leone"} pageName="Program Reports" />
      <Allreports reportsdata={reportdata as IReportData[]} />
    </>
  );
};

export default SierraLeoneReportsPage;
