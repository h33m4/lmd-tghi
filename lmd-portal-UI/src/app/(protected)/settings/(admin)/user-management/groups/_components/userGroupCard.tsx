...
import { IUserGroup } from "./userGroupTable";
...
function getGroupColor(groupName: string): string {
  switch (groupName) {
    ...
    case "global_publisher":
      return "#8A63D2";
    case "liberia_publisher":
      return "#11A849";
    case "malawi_publisher":
      return "#F5A623";
    case "ethiopia_publisher":
      return "#8e3068";
    case "siera-leone_publisher":
      return "#193946";
    default:
      return "#757425";
  }
