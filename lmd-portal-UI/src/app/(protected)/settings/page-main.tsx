...
const payments = [
  {
    ...
    date: "1/1/2020",
    datetime: "2020-01-01",
    description: "Business Plannn - Annual Billing",
    amount: "CA$109.00",
    href: "#",
  },
  {
    ...
    <>
      <div className="h-full ">
        <main className="mx-auto max-w-7xl pb-10 lg:py-12 lg:px-8">
          <div className="lg:grid lg:grid-cols-12 lg:gap-x-5 border border-red-400">
            <aside className="py-6 px-2 sm:px-6 lg:col-span-3 lg:py-0 lg:px-0  border">
                ...
                {subNavigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current
                        ? "bg-gray-50 text-orange-600 hover:bg-background"
            ...
            <div className="space-y-6 sm:px-6 lg:col-span-9 lg:px-0">
              <section aria-labelledby="payment-details-heading">
                <form action="#" method="POST">
                  <div className="shadow sm:overflow-hidden sm:rounded-md">
                    <div className="bg-background py-6 px-4 sm:p-6">
                      <div>
                        <h2
                      ...
                      <div className="mt-6 grid grid-cols-4 gap-6">
                        ...
                        <div className="col-span-4 sm:col-span-2">
                          ...
                          <select
                            ...
                            className="mt-1 block w-full rounded-md border border-gray-300 bg-background py-2 px-3 shadow-sm focus:border-gray-900 focus:outline-none focus:ring-gray-900 sm:text-sm"
                          >
              ...
              <section aria-labelledby="plan-heading">
                <form action="#" method="POST">
                  <div className="shadow sm:overflow-hidden sm:rounded-md">
                    <div className="space-y-6 bg-background py-6 px-4 sm:p-6">
                      <div>
                        <h2
                          id="plan-heading"
                          className="text-lg font-medium leading-6 text-gray-900"
                      ...
                      >
                        ...
                        <div className="relative -space-y-px rounded-md bg-background">
                          ...
                          <span
                            ...
                            className={classNames(
                              annualBillingEnabled
                                ? "translate-x-5"
                                : "translate-x-0",
                              "inline-block h-5 w-5 transform rounded-full bg-background shadow ring-0 transition duration-200 ease-in-out"
                            )}
                          />
                        </Switch>
              ...
              <section aria-labelledby="billing-history-heading">
                <div className="bg-background pt-6 shadow sm:overflow-hidden sm:rounded-md">
