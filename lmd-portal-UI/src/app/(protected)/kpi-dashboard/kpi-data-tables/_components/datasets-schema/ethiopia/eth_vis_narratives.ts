...
// define schema
const ethVisNarratives_schema = z.object({
...
interface IEthVisNarratives extends z.infer<typeof ethVisNarratives_schema> {}

const customColumns: Partial<ColDef<IEthVisNarratives, any>>[] = [
...
const ethVisNarratives_columns: ColDef<IEthVisNarratives, any>[] =
  generateDefaultColumns<IEthVisNarratives>(
    ethVisNarratives_schema,
    customColumns
  );

export { ethVisNarratives_columns, ethVisNarratives_schema };
export type { IEthVisNarratives };
