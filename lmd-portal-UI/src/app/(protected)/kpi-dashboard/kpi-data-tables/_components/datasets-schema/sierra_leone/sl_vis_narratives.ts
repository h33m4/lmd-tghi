...
// define schema
const slVisNarratives_schema = z.object({
...
interface ISlVisNarratives extends z.infer<typeof slVisNarratives_schema> {}

const customColumns: Partial<ColDef<ISlVisNarratives, any>>[] = [
...
const slVisNarratives_columns: ColDef<ISlVisNarratives, any>[] =
  generateDefaultColumns<ISlVisNarratives>(
    slVisNarratives_schema,
    customColumns
  );

export { slVisNarratives_columns, slVisNarratives_schema };
export type { ISlVisNarratives };
