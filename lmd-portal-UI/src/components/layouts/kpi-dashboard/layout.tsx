...
const COOKIE_KEY_COLLAPSED = "kpi-sidebar:collapsed";
...
const KPIDashboardLayout: React.FC<Props> = ({
  children,
    ...
    <div className="w-full flex flex-1 overflow-hidden">
      ...
      <aside
        ...
        className={cn(
          ...
          !isCollapsed && `2xl:!w-[${SIDEBAR_EXPANDED_WIDTH_2XL}px]`
        )}
      >
      ...
      <main className="flex-1 h-[calc(100vh-80px)] 2xl:h-[calc(100vh-90px)] overflow-auto px-2 py-2">
        {children}
      </main>
    </div>
  );
