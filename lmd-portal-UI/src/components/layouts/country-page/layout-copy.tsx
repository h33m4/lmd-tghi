...
CountrydashboardLayoutProps) => {
  ...
  return (
    ...
    >
      ...
      {/* <ResizableHandle withHandle isCollapsed={isCollapsed} /> */}

      <div
        className={cn(
          "relative cursor-none border-none border-red-600  flex w-px items-center justify-center bg-border after:absolute after:inset-y-0 after:left-1/2 after:w-1 after:-translate-x-1/2 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 data-[panel-group-direction=vertical]:h-px data-[panel-group-direction=vertical]:w-full data-[panel-group-direction=vertical]:after:left-0 data-[panel-group-direction=vertical]:after:h-1 data-[panel-group-direction=vertical]:after:w-full data-[panel-group-direction=vertical]:after:-translate-y-1/2 data-[panel-group-direction=vertical]:after:translate-x-0 [&[data-panel-group-direction=vertical]>div]:rotate-90 border"
        )}
      >
        <button
      ...
      <ResizablePanel
        ...
        className="w-full h-[calc(100vh-80px)] 2xl:h-[calc(100vh-88px)] flex flex-grow flex-col overflow-auto  px-2 py-2"
      >
        {children}
      </ResizablePanel>
      {/* <RightSidebar /> */}
