...
type Props = {
  ...
  rightButtonComponent?: React.JSX.Element;
  buttonComponentClassName?: string;
};
  ...
  return (
    <>
      ...
      <div
        ...
        className={cn("", buttonComponentClassName)}
      >
        {buttonComponent}
      </div>
            ...
            >
              ...
              >
                ...
                >
                  {/* Modal Header */}
                  <Dialog.Title>
                    <div className="h-[46px] flex-none flex items-center justify-between px-3 py-4 border-b-[0.5px] border bg-background  rounded-t-lg ">
                  ...
                  >
                    {/* Modal Components */}
                    <div>
                      {renderBool && <div className="pr-1">{components}</div>}
                    </div>
